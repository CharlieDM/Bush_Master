...
#define ELECTRIC_HEAT1_ON     	Device.Gpio.DoutOn(GPIO_PORT_DOUT1,ELECTRIC_HEAT0) 
#define ELECTRIC_HEAT1_OFF     	Device.Gpio.DoutOff(GPIO_PORT_DOUT1,ELECTRIC_HEAT0) 

#define ELECTRIC_HEAT2_ON      	Device.Gpio.DoutOn(GPIO_PORT_DOUT1,ELECTRIC_HEAT1) 
#define ELECTRIC_HEAT2_OFF     	Device.Gpio.DoutOff(GPIO_PORT_DOUT1,ELECTRIC_HEAT1) 

#define ELECTRIC_HEAT3_ON      	Device.Gpio.DoutOn(GPIO_PORT_DOUT1,AIR_ELECTRIC_HEAT) 
#define ELECTRIC_HEAT3_OFF     	Device.Gpio.DoutOff(GPIO_PORT_DOUT1,AIR_ELECTRIC_HEAT) 
